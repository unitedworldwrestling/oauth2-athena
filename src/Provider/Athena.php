...
use Unitedworldwrestling\OAuth2\Client\Grant\AthenaApiKey;
...
class Athena extends AbstractProvider
{
    ...
    public function __construct(array $options = [], array $collaborators = [])
    {
        ...
        if (empty($collaborators['grantFactory'])) {
            ...
            $collaborators['grantFactory']->setGrant('https://athena.uww.io/grants/api_key', new AthenaApiKey);
        }
    ...
    {
        return new AthenaResourceOwner($response, $this->responseResourceOwnerId);
    }
}
